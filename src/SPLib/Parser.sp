...
andThen as fn fn a: Parser t b: fn Parser t a: Parser t b =
    ...
    try firstParser re0 readState as
        re1 & 'accepted nextReadState a: (chainedParser a) re1 nextReadState
        re1 & 'rejected: re1 & 'rejected
        re1 & 'aborted rs e: re1 & 'aborted rs e
...
thenWithDefault as fn Parser t b, fn a: Parser t b: fn Parser t a: Parser t b =
    ...
    fn re0, readState:
    try firstParser re0 readState as
        re1 & 'aborted rs reason: re1 & 'aborted rs reason
        re1 & 'rejected: fallbackParser re1 readState
        re1 & 'accepted nextReadState a: (chainedParser a) re1 nextReadState
...
without as fn Parser t o: Parser t None =
    fn p:
    p
    >> thenWithDefault (accept 'none) fn _:
    reject
    ...
    try ps as
        ...
        headParser :: tailParsers:
            try headParser rejections readState as
                re1 & 'rejected: (oneOf tailParsers) re1 readState
                acceptedOrAborted: acceptedOrAborted


maybe as fn Parser t o: Parser t (Maybe o) =
    fn p:
    p
    >> thenWithDefault (accept 'nothing) fn x:
    accept << 'just x
...
zeroOrMore as fn Parser t o: Parser t [ o ] =
    fn p:
    p
    >> thenWithDefault (accept []) fn head:
    zeroOrMore p
    >> andThen fn tail:
    accept (head :: tail)
