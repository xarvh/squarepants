...
mapRes as fn (fn k, a: Result e b), Dict k a: Result e (Dict k b) =
  ...
  try dict as
    ...
    , RBNode_elm_builtin color key value left right:
        func key value >> Result.onOk fn one:
        mapRes func left >> Result.onOk fn two:
        mapRes func right >> Result.onOk fn three:
...
for as fn b, Dict k v, (fn k, v, b: b): b =
  ...
  try dict as
    ...
    , RBNode_elm_builtin _ key value left right:
      for (func key value (for acc left func)) right func
...
forRes as fn b, Dict k v, (fn k, v, b: Result e b): Result e b =
    ...
    try dict as
        ...
        , RBNode_elm_builtin _ key value left right:
            forRes acc left func >> Result.onOk fn l:
            func key value l >> Result.onOk fn f:
            forRes f right func
...
forReversed as fn b, Dict k v, (fn k, v, b: b): b =
  ...
  try t as
    ...
    , RBNode_elm_builtin _ key value left right:
      forReversed (func key value (forReversed acc right func)) left func
