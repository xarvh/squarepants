    ...
    Test.Group "Blocks, sibling lines, indentation"
        [ codeTest "1"
            ...
            (Test.isOkAndEqualTo
                ...
                , Token 1 2 << non_mut_name "a"
                , Token 3 4 << Token.Defop Token.DefNormal
                ...
                , Token 10 11 << Token.Defop Token.DefNormal
        ...
        , codeTest
            ...
            (Test.isOkAndEqualTo
                ...
                , Token 51 52 << Token.Defop Token.DefNormal
        ...
        , codeTest
            ...
            (Test.isOkAndEqualTo
                ...
                , Token (14) (15) (Token.Defop (Token.DefNormal))
                ...
                , Token (73) (74) (Token.Defop (Token.DefNormal))
                ...
                , Token (104) (105) (Token.Defop (Token.DefNormal))
                ...
                , Token (188) (189) (Token.Defop (Token.DefNormal))
                ...
                , Token (247) (248) (Token.Defop (Token.DefNormal))
    ...
    Test.Group "Comments"
        [ codeTest "[reg] statement after comment"
            ...
            (Test.isOkAndEqualTo
                ...
                , Token 5 6 << Token.Defop Token.DefNormal
        ...
        , codeTest "[reg] nested comments allow a spurious newline?"
            ...
            (Test.isOkAndEqualTo
                ...
                , Token 12 13 << Token.Defop Token.DefNormal
...
"""
            ...
            (Test.isOkAndEqualTo
                ...
                , Token 34 35 << Token.Defop Token.DefNormal
        ...
        , codeTest
            ...
            (Test.isOkAndEqualTo
                ...
                , Token 9 10 << Token.Defop Token.DefNormal
