    ...
    Test.Group "Blocks, sibling lines, indentation"
        ...
        , codeTest
            ...
            (Test.isOkAndEqualTo
                ...
                , Token (38) (40) (Token.Binop ({associativity = Types/Op.Left , nonFn = [], precedence = Types/Op.Pipe , symbol = ">>", type = CA.TypeFunction (Pos.N ) (CA.TypeFunction (Pos.N ) (CA.TypeVariable (Pos.N ) ("a")) (False) (CA.TypeVariable (Pos.N ) ("b"))) (False) (CA.TypeFunction (Pos.N ) (CA.TypeVariable (Pos.N ) ("a")) (False) (CA.TypeVariable (Pos.N ) ("b")))}))
                , Token (41) (42) (Token.LowerName (Token.NameNoModifier ) (Nothing ) ("k") ([]))
                , Token (55) (57) (Token.Binop ({associativity = Types/Op.Left , nonFn = [], precedence = Types/Op.Pipe , symbol = ">>", type = CA.TypeFunction (Pos.N ) (CA.TypeFunction (Pos.N ) (CA.TypeVariable (Pos.N ) ("a")) (False) (CA.TypeVariable (Pos.N ) ("b"))) (False) (CA.TypeFunction (Pos.N ) (CA.TypeVariable (Pos.N ) ("a")) (False) (CA.TypeVariable (Pos.N ) ("b")))}))
